...
export function saveBookingIntent(intent: Omit<BookingIntent, 'timestamp'>): void {
  ...
  try {
    sessionStorage.setItem(BOOKING_INTENT_KEY, JSON.stringify(intentWithTimestamp));
  } catch (error) {
