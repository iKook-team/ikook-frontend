...
export const TransactionTabs: React.FC<TransactionTabsProps> = ({ activeTab, onTabChange }) => {
  return (
    <nav className="flex w-[392px] max-w-full items-stretch gap-5 text-xs font-medium whitespace-nowrap leading-none justify-between bg-[#B7B7B6] mt-6 p-1 rounded-[4.547px]" role="tablist">
      <button
        role="tab"
