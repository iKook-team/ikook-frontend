...
export const WelcomeSection: React.FC<WelcomeSectionProps> = ({
  ...
  return (
    <section className="flex flex-col items-center text-center">
      ...
      />
      <h1 className="text-black text-[19px] font-bold w-[316px] h-[29px] text-center mb-[30px] max-md:text-[17px] max-md:w-full max-sm:text-base max-sm:w-full max-sm:mb-[15px]">
        LETS GET YOU STARTED ON iKOOK
      </h1>
      <p className="w-[508px] text-[#7C7C7C] text-center text-[15px] font-normal h-[46px] mb-[50px] max-md:w-full max-md:text-sm max-md:mb-[60px] max-sm:w-full max-sm:text-[13px] max-sm:mb-10">
