...
const HowItWorksSection = () => {
  const features = [
    {
      title: "Signup",
      description: "Sign up today and gain access to a world of delicious menus, crafted by professional chefs.",
      imageSrc: "https://api.builder.io/api/v1/image/assets/TEMP/a52557fbbec295fc841880ad75b27d2eb0e726ad?width=1096",
    ...
    },
    {
      ...
      description: "Booking is easy – simply choose a menu that appeals to you. Can't find what you want? you can use the custom booking to get customized menu.",
      imageSrc: "https://api.builder.io/api/v1/image/assets/TEMP/93ac7e9b063966644e3ea66a9aabcd709ec777dc?width=1096",
    ...
    {
      title: "Payment",
      description: "Enjoy the convenience of seamless, secure online payments! Our platform offers a fast, easy, and secure way to pay for your experience.",
      imageSrc: "https://api.builder.io/api/v1/image/assets/TEMP/f215fbd418d137033d9f0322e9314e3a304a2139?width=1096",
    ...
    {
      title: "Event Date",
      description: "Our chefs take care of the rest, bringing the restaurant experience right to your kitchen. Experience the ultimate in personalized dining.",
      imageSrc: "https://api.builder.io/api/v1/image/assets/TEMP/532808ee086a85b69b09223b96bffe122e220bfe?width=1096",
