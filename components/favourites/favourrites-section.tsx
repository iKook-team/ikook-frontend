      ...
      if (activeTab === 'menus') {
        const menus = response.results
          ...
          .map(item => {
            ...
            const chef = menu.chef || { first_name: '', last_name: '', city: '', average_rating: 0, num_reviews: 0 };
            return {
              id: menu.id,
              title: menu.name,
              ...
              chefImageUrl: chef.avatar || 'https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp&f=y',
            };
          });
        ...
        const chefs = response.results
          ...
          .map(item => {
            ...
            return {
              ...
              description: chef.bio || 'Professional chef with years of experience.',
              services: chef.chef_services || [],
              mainImageUrl: chef.link_to_cooking_images || '/placeholder-chef-bg.jpg',
              profileImageUrl: chef.avatar || 'https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp&f=y',
