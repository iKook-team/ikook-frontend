...
export const ReferenceList: React.FC = () => {
  ...
  const [editingReferenceId, setEditingReferenceId] = useState<number | undefined>(undefined);
  ...
  return (
    <section className="self-center flex w-[662px] max-w-full flex-col mt-[35px]">
      ...
      >
        <span className="text-white self-stretch my-auto">Add new reference</span>
      </button>
