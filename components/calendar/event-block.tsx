...
import { BookingEvent } from "./calendar-grid";
...
export default function EventBlock({ event, onClick, isSelected, weekDates }: EventBlockProps) {
  ...
  const height = ((endHour - startHour) * 60 + (endMinute - startMinute)) * (64 / 60);
  return (
    <div 
