...
export const AdHowItWorks: React.FC = () => {
  const steps = [
    {
      icon: (
        <svg className="w-12 h-12 text-[#FCC01C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Choose from our vetted professional chefs that match your needs"
    },
    {
      icon: (
        <svg className="w-12 h-12 text-[#FCC01C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
