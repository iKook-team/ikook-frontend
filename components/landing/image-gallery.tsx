...
export const ImageGallery: React.FC = () => {
  return (
    <section className="self-stretch flex items-stretch gap-[11px] flex-wrap mt-[65px] max-md:mt-10">
      <div className="max-md:max-w-full">
        <img
          ...
          className="aspect-[2.67] object-contain w-full rounded-[13px] max-md:max-w-full"
          alt="Featured dish"
        />
          ...
          <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
            <div className="w-[65%] max-md:w-full max-md:ml-0">
              <img
                ...
                className="aspect-[2.48] object-contain w-full grow rounded-[13px] max-md:mt-[22px]"
                alt="Cuisine variety"
              />
            </div>
            <div className="w-[35%] ml-5 max-md:w-full max-md:ml-0">
              <img
                ...
                className="aspect-[1.33] object-contain w-[200px] shrink-0 max-w-full grow rounded-[13px] max-md:mt-[22px]"
      ...
      <img
        ...
        className="aspect-[0.59] object-contain w-[200px] shrink-0 max-w-full mt-[42px] rounded-[13px] max-md:mt-10"
      ...
      <div>
        <img
          ...
          className="aspect-[1.99] object-contain w-full rounded-[13px]"
        ...
        <img
          ...
          className="aspect-[1.77] object-contain w-full mt-9 rounded-[13px]"
          alt="Culinary art"
        />
      </div>
      <img
        ...
        className="aspect-[0.77] object-contain w-[292px] shrink-0 max-w-full rounded-[13px]"
        alt="Gourmet meal"
      />
    </section>
  );
