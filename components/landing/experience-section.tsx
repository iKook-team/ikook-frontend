        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-8">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-medium leading-tight">
              ...
              at your home or for any occasion! Our app will connect you with trained 
              chefs who tailor to your exact needs.
            </h2>
            
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                className="bg-white hover:bg-gray-100 text-[#323335] font-semibold px-8 py-4 rounded-md"
              >
                Get Started
              </Button>
