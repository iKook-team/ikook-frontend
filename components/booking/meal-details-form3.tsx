                ...
                {['Breakfast', 'Lunch', 'Dinner'].map((option) => (
                  <label key={option} className="flex items-center">
                    <input
                      ...
                      onChange={() => handleInputChange('mealType', option as 'Breakfast' | 'Lunch' | 'Dinner')}
            ...
            <div>
              ...
              <div className="mb-2">
                <TagSelector
                  ...
                  onChange={(selected) => handleInputChange('preferredCuisines', selected)}
                  placeholder="Select preferred cuisines..."
                />
              </div>
              <p className="text-xs text-gray-500 mt-1">Select at least one cuisine</p>
            </div>
