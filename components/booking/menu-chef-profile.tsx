          ...
          <div className="max-md:max-w-full max-md:mt-9">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="self-stretch min-w-60 my-auto">
                  <h4 className="text-base font-semibold">
                    {chef?.first_name
                      ? `Chef ${chef.first_name} is available`
                      : "Congratulations, available for booking"}
                  </h4>
                  <p className="text-sm font-normal leading-none">
                    {chef?.first_name
                      ? `${chef.first_name} is usually fully booked.`
                      : "This chef is usually fully booked."}
                  </p>
                </div>
              </div>
            </div>
            <div className="flex w-full flex-col text-sm font-semibold bg-[#FFFCF5] mt-4 pt-[17px] pb-[33px] px-[19px] rounded-[15px] max-md:max-w-full max-md:pr-5">
              ...
              <p className="text-[#3F3E3D] font-normal leading-5 self-stretch mt-[21px] max-md:max-w-full">
                Just message{" "}
                {chef?.first_name ? `chef ${chef.first_name}` : "the chef"} and
                discuss the details of your event and the requirements you have.
              </p>
              <button
              ...
              >
                <div
                  className="text-[#344054] self-stretch border border-[color:var(--Gray-300,#D0D5DD)] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)] gap-2 overflow-hidden bg-white px-3.5 py-2 rounded-lg border-solid flex items-center justify-center min-w-[120px]"
