...
const EventDetailsForm3: React.FC<EventDetailsForm3Props> = ({ onNext, onBack, menu, formData, onChange }) => {
  const progressSteps = [
    ...
    <main className="w-[655px] h-[852px] absolute left-[393px] top-[177px]">
      ...
      <section className="absolute left-5 top-[307px] w-[613px]">
        ...
        <form className="flex flex-col flex-1 w-full" onSubmit={e => { e.preventDefault(); handleContinue(); }}>
          <label htmlFor="eventTime" className="text-[#344054] text-sm font-medium leading-none mb-2">Event Time</label>
          <input
            type="time"
            id="eventTime"
            name="eventTime"
          ...
          />
          <h3 className="text-[#344054] text-sm font-medium leading-none block mb-2">Venue</h3>
