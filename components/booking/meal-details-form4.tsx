...
const MealDetailsForm4: React.FC<MealDetailsForm4Props> = ({ onNext, onBack }) => {
    ...
    <main className="w-[655px] h-[852px] absolute left-[393px] top-[177px]">
      ...
      <section className="absolute left-5 top-[307px] w-[613px]">
        ...
        <form className="flex flex-col flex-1 w-full" onSubmit={e => { e.preventDefault(); handleContinue(); }}>
          <label htmlFor="startDate" className="text-[#344054] text-sm font-medium leading-none mb-2">Start date</label>
          <input
            type="date"
            id="startDate"
            name="startDate"
          ...
          />
          <label htmlFor="endDate" className="text-[#344054] text-sm font-medium leading-none mb-2">End date</label>
          <input
            type="date"
            id="endDate"
            name="endDate"
          ...
          />
          <label htmlFor="deliveryTime" className="text-[#344054] text-sm font-medium leading-none mb-2">Delivery time</label>
          <input
            type="time"
            id="deliveryTime"
            name="deliveryTime"
