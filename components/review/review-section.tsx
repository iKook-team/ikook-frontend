      ...
      <div className="flex gap-5 max-md:flex-col max-md:">
        ...
        <div className="ml-5 w-[58%] max-md:ml-0 max-md:w-full">
          <div className="flex gap-6 mt-20 w-full max-md:mt-10 max-md:max-w-full">
            ...
            <button className="flex overflow-hidden gap-2 justify-center items-center px-3.5 py-3 text-base font-semibold text-white bg-amber-400 rounded-lg border border-amber-400 border-solid shadow-sm">
