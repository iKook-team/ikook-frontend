    ...
    <section className="w-full max-w-[885px] mt-8 max-md:w-[calc(100%_-_40px)] max-md:max-w-[800px] max-sm:w-[calc(100%_-_32px)]">
      ...
      <div className="flex w-full items-center gap-3 h-9 bg-[#FFFCF5] mt-6 p-2 rounded-md max-md:w-full max-sm:gap-2 max-sm:p-3">
        <div className="w-5 h-5 relative">
          <svg className="absolute left-0 top-0" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="10" cy="10" r="10" fill="#FDEEC5" />
          </svg>
          <svg className="absolute left-1 top-1" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M6 4V7M6 8.5V8.505M11.5 6C11.5 9.03757 9.03757 11.5 6 11.5C2.96243 11.5 0.5 9.03757 0.5 6C0.5 2.96243 2.96243 0.5 6 0.5C9.03757 0.5 11.5 2.96243 11.5 6Z" stroke="#A07A13" strokeLinecap="round" />
          </svg>
        </div>
